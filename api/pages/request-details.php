...
$sql = mysqli_query($conn, "SELECT * FROM purchase_order Where ID  ='$id'");
                                    ...
                                    <div class="col-md-12">
                                        <div class="card-body">
                                            <div class="text-center">
                                                ...
                                                <!-- Item Image -->
                                                <?php
                                                            $sql = mysqli_query($conn, "SELECT ITEM_PHOTO FROM purchase_order Where ID  ='$id'");
                                                            while ($image = mysqli_fetch_array($sql)) {
                                                        ?>
                                                <embed type="image/jpg" src="../ITEM_PHOTO/<?php if (empty($image['ITEM_PHOTO'])) {
                                                                                    $image['ITEM_PHOTO'] = 'default.png';
                                                                                    echo $image['ITEM_PHOTO'];
                                                                                } else {
                                                                                    echo $image['ITEM_PHOTO'];
                                                                                    } ?>" style="height:220px;">
                                                <?php } ?>
                                                <?php if ($_SESSION['ACCESS'] == 'ENCODER' || $_SESSION['ACCESS'] == 'ADMIN') { ?>
                                                <div class="my-3">
                                        ...
                                        <div class="tab-content">
                                                ...
                                                <form class="row g-3" method="post" id="purchase_details_form">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="STATUS" id="STATUS" class="form-select" disabled
                                                            <?php echo ($_SESSION['ACCESS'] == 'REQUESTOR') ? 'disabled' : ''; ?>>
                                            ...
                                            <div class="tab-pane fade" id="attachments" role="tabpanel">
                                                ...
                                                <div class="card-body">
                                                    <div class="col-xl-12">
                                                        <div class="card">
                                                            <?php $sql="SELECT ATTACHMENTS FROM purchase_order Where ID = '".$row['ID']."' ";
                                                            ...
                                                            <embed type="application/pdf"
                                                                src="../PO_ATTACHMENTS/<?php echo $info['ATTACHMENTS'];?>"
                                                        ...
                                                        <div class="card-body">
                                                            <ul class="timeline">
                                                                <?php 
                                                                        ...
                                                                        $sql_history = mysqli_query($conn, "SELECT * FROM po_history WHERE REQUEST_ID = '$request_id' ORDER BY DATE_CREATED DESC");
                                                                        $classes = ['primary','success', 'danger', 'info', 'warning'];
                                                                        $class_index = 0; // Initialize class index
                                                                        while ($row_sql_history = mysqli_fetch_assoc($sql_history)) {
                                                                ...
                                                                <li class="timeline-item timeline-item-transparent">
                                                                    <span class="timeline-point-wrapper"><span
                                                                            class="timeline-point timeline-point-<?php echo $class; ?>"></span></span>
                                                                    <div class="timeline-event">
                                                                        <div class="timeline-header border-bottom mb-3">
                                                                            <h6 class="mb-0">
                                                                                <?php echo $row_sql_history['TITLE']; ?>
                                                                            </h6>
                                                                            <span
                                                                                class="text-muted"><?php echo date('M d,Y', strtotime($row_sql_history['DATE_CREATED'])); ?></span>
                                                                        </div>
                                                                        <div
                                                                            class="d-flex justify-content-between flex-wrap mb-2">
                                                                            <div>
                                                                                <span><?php echo nl2br($row_sql_history['REMARKS']); ?></span>
                                                                            </div>
                                                                            <div>
                                                                                <span
                                                                                    class="text-muted"><?php echo date('h:i:s A', strtotime($row_sql_history['DATE_CREATED'])); ?></span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </li>
