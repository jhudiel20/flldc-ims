                                    ...
                                    <div class="col-md-12">
                                        <div class="card-body">
                                            <div class="text-center">
                                                ...
                                                <!-- Item Image -->
                                                <embed type="image/jpg" src="/ITEM_PHOTO/<?php if (empty($user['item_photo'])) {
                                                                                    $user['item_photo'] = 'default.png';
                                                                                    echo $user['item_photo'];
                                                                                } else {
                                                                                    echo $user['item_photo'];
                                                                                    } ?>" style="height:220px;">
                                                    ...
                                                    <div class="col-xl-12">
                                                        <div class="card">
                                                            ...
                                                            <embed type="application/pdf"
                                                                src="/PO_ATTACHMENTS/<?php echo $user['attachments'];?>"
