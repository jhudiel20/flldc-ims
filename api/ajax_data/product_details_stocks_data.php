...
$dbfield = array('TABLE_ID','ID','QUANTITY', 'MEASUREMENT', 'EXPIRATION', 'CREATED_BY', 'REMARKS', 'DATE_CREATED'); // need iset based sa table columns na need sa query
$db_orig = array('TABLE_ID','ID','QUANTITY', 'MEASUREMENT', 'EXPIRATION', 'CREATED_BY', 'REMARKS', 'DATE_CREATED'); //gamit sa filter  tabulator
...
array_push($sql_where_array, " ID = '$product_code'"); //set default WHERE CONDITION HERE
...
$default_query ="SELECT ".$field_query." FROM stock_logs ".$sql_conds;
...
$default_query ="SELECT ".$field_query." FROM stock_logs ".$sql_conds." ORDER BY DATE_CREATED DESC";
