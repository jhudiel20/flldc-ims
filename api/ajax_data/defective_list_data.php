...
$db_orig = array('t.TRANSACTION_ID','DEFECTIVE','td.PRODUCTS','DEFEC_DATE_CREATED'); 
...
array_push($sql_where_array, " td.DEFECTIVE != '' OR td.DEFECTIVE > 0"); //set default WHERE CONDITION HERE
