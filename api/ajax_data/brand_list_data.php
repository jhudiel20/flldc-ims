...
$dbfield = array('ID','BRAND_CODE','NAME','ADDED_BY','DATE_CREATED'); // need iset based sa table columns na need sa query
$db_orig = array('ID','BRAND_CODE','NAME','ADDED_BY','DATE_CREATED'); //gamit sa filter  tabulator
...
$default_query ="SELECT ".$field_query." FROM brands ".$sql_conds;
...
$default_query ="SELECT ".$field_query." FROM brands ".$sql_conds." ORDER BY ".$orderby;
