...
$query_fields = ['id', 'reservation_id', 'reserve_date', 'business_unit', 'room','contact','email','chair','"table"','hdmi','extension','message','reserve_status','guest','time','setup','booking_id'];
