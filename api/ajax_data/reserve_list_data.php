...
$query_fields = ['id', 'reservation_id', 'reserve_date', 'fname', 'lname', 'business_unit', 'room', 'roomid','contact','email','chair','"table"','hdmi','extension','message','reserve_status','guest','time','setup','booking_id'];
