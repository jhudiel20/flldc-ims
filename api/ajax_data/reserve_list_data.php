...
$query_fields = ['id', 'reservation_id', 'reserve_date', 'fname', 'lname', 'business_unit', 'room', 'roomid','contact','email','chair','"table"','hdmi','extension','message','reserve_status','guest','time','setup','booking_id','invoice'];

if (!empty($sorters)) {
    $valid_sorts = ['id', 'reservation_id', 'reserve_date', 'business_unit', 'room','contact','email','chair','table','hdmi','extension','message','reserve_status','guest','time','setup','date_created','booking_id','invoice'];
