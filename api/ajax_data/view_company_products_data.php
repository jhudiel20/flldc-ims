...
$COMPANY_NAME = mysqli_real_escape_string($conn, isset($_POST['COMPANY_NAME']) ? trim($_POST['COMPANY_NAME']) : '');
...
$dbfield = array('ID','PRODUCT_NAME','PRICE', 'CATEGORY_NAME', 'SUBCATEGORY_NAME','TYPE', 'DATE_CREATED'); // need iset based sa table columns na need sa query
$db_orig = array('ID','PRODUCT_NAME','PRICE', 'CATEGORY_NAME', 'SUBCATEGORY_NAME','TYPE', 'DATE_CREATED'); //gamit sa filter  tabulator
...
array_push($sql_where_array, " SUPPLIER_NAME = '$COMPANY_NAME' "); //set default WHERE CONDITION HERE
