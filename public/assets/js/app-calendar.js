...
document.addEventListener('DOMContentLoaded', function () {
  (function () {
    ...
    function eventClick(info) {
      ...
      start.setDate(eventToUpdate.start, true, 'Y-m-d HH:mm');
      console.log(eventToUpdate.start);
    ...
    function fetchEvents(info, successCallback) {
        ...
        $.ajax({
            ...
            success: function (result) {
                // console.log("Raw events:", result.events); // Check the raw events
        
                // Get requested calendars as Array
                var calendars = selectedCalendars();
                // console.log("Selected calendars:", calendars); // Check the selected calendars
                
                // Filter events based on selected calendars
                // var filteredEvents = result.events.filter(event => calendars.includes(event.extendedProps.calendar));
                let filteredEvents = result.events.filter(function (events) {
                    // console.log(event.extendedProps.calendar.toLowerCase());
                    return calendars.includes(events.extendedProps.calendar.toLowerCase());
                });
                // console.log("Filtered events:", filteredEvents); // Check the filtered events
                
                // Call the success callback with filtered events
