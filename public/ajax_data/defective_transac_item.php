...
$dbfield = array('t.TRANSACTION_ID','DEFECTIVE','td.PRODUCTS','DEFEC_DATE_CREATED'); // need iset based sa table columns na need sa query
$db_orig = array('t.TRANSACTION_ID','DEFECTIVE','td.PRODUCTS','DEFEC_DATE_CREATED'); //gamit sa filter  tabulator
...
array_push($sql_where_array, " t.TRANSACTION_ID = '$transaction_id' AND td.DEFECTIVE != '' OR td.DEFECTIVE > 0"); //set default WHERE CONDITION HERE
