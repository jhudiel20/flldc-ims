...
$sorters =array();
$orderby ="APPROVAL_DATE_CREATED DESC";
$sql_where="";
$sql_conds="";
...
$dbfield = array('ID','PR_ID','ITEM_NAME','QUANTITY','EMAIL','STATUS','REMARKS','ATTACHMENTS'); // need iset based sa table columns na need sa query
...
array_push($sql_where_array, " APPROVAL = 'APPROVED'"); //set default WHERE CONDITION HERE
...
$default_query ="SELECT ".$field_query.",DATE_FORMAT(APPROVAL_DATE_CREATED, '%Y-%m-%d %h:%i:%s %p') as APPROVAL_DATE_CREATED 
